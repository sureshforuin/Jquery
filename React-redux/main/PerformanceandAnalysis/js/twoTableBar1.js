$(document).ready(function() {
    ...
    $("#tab-4 .time-nav").on("change", "input", function(e) {
        ...
        categoryXData();
        twoTableBarChart1.xAxis[0].categories = categoryX;
        twoTableBarChart1.xAxis[1].categories = categoryX;
        twoTableBarChart1.series[0].setData(categoriesData, true);
    ...
    var createChart = function () {
        twoTableBarChart1 = Highcharts.chart("twoTableBar1", {
            chart: {
                type: "bar",
