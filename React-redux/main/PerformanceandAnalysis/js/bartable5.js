$(document).ready(function() {
    ...
    $("#tab-3 .time-nav").on("change", "input", function(e) {
        ...
        categoryXData();
        tableBarChart5.xAxis[0].categories = categoryX;
        tableBarChart5.xAxis[1].categories = categoryX;
        tableBarChart5.series[0].setData(categoriesData, true);
    });
    ...
    tableBarChart5 = Highcharts.chart("tableBar5", {
        chart: {
            type: "bar",
