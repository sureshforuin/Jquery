$(document).ready(function() {
    ...
    $("#tab-4 .time-nav").on("change", "input", function(e) {
        ...
        categoryXData();
        twoTableBarChart3.xAxis[0].categories = categoryX;
        twoTableBarChart3.xAxis[1].categories = categoryX;
        twoTableBarChart3.series[0].setData(categoriesData, true);
    });
    ...
    twoTableBarChart3 = Highcharts.chart("twoTableBar3", {
        chart: {
            type: "bar",
