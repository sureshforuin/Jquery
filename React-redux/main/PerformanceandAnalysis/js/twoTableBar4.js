$(document).ready(function() {
    ...
    $("#tab-4 .time-nav").on("change", "input", function(e) {
        ...
        categoryXData();
        twoTableBarChart4.xAxis[0].categories = categoryX;
        twoTableBarChart4.xAxis[1].categories = categoryX;
        twoTableBarChart4.series[0].setData(categoriesData, true);
    });
    ...
    twoTableBarChart4 = Highcharts.chart("twoTableBar4", {
        chart: {
            type: "bar",
