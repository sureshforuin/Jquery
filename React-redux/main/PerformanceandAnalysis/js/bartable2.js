$(document).ready(function() {
    ...
    $("#tab-3 .time-nav").on("change", "input", function(e) {
        ...
        categoryXData();
        tableBarChart2.xAxis[0].categories = categoryX;
        tableBarChart2.xAxis[1].categories = categoryX;
        tableBarChart2.series[0].setData(categoriesData, true);
    });
    ...
    tableBarChart2 = Highcharts.chart("tableBar2", {
        chart: {
            type: "bar",
