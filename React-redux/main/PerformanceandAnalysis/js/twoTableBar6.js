$(document).ready(function() {
    ...
    $("#tab-4 .time-nav").on("change", "input", function(e) {
        ...
        categoryXData();
        twoTableBarChart6.xAxis[0].categories = categoryX;
        twoTableBarChart6.xAxis[1].categories = categoryX;
        twoTableBarChart6.series[0].setData(categoriesData, true);
    });
    ...
    twoTableBarChart6 = Highcharts.chart("twoTableBar6", {
        chart: {
            type: "bar",
